...
This to me displays  the brilliance of `gganimate` and a testament to Thomas' unwavering focus on the grammar and API of the package. David Robinson summed it up best with "An amazing example of how gganimate lets you accomplish so much with so little." 
